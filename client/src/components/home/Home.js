...
<Box sx={{ flexGrow: 1}} className="gradient">
      <Grid>
        ...
        fullWidth sx={{height:"100vh",width:"100vw",bottom: "0", boxShadow: "0", bgcolor: "none"}}>
            <img src={homeLogo} alt="" className="homeLogo"/>
            <Typography className="typH" sx={{marginBottom: "1%", fontSize: "43px", color: "White"}}>
                What we do?
            </Typography>
            <Typography className="typB" sx={{marginBottom: "1%", fontSize: "24px",color: "White"}}>
